...
import com.pexip.chatapp.service.ProfileService;
...
public class ProfileHandler {
    ...
    public Mono<ServerResponse> updateById(ServerRequest r) {
        Flux<Profile> id = r.bodyToFlux(Profile.class)
                .flatMap(p -> this.profileService.update(id(r), p.getName()));
    ...
    public Mono<ServerResponse> create(ServerRequest request) {
        Flux<Profile> flux = request
                ...
                .flatMap(toWrite -> this.profileService.create(toWrite.getName()));
